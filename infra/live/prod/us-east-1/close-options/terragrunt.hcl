...
inputs = {
  ...
  package_source_files  = ["trading/__init__.py", "trading/close_options.py", "trading/close_options_lambda_handler.py", "trading/logging_utils.py", "trading/tradier_market.py"]
  python_version        = "3.12"
  memory_size           = 256
  timeout               = 300

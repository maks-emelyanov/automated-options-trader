...
inputs = {
  ...
  package_source_files  = ["trading/__init__.py", "trading/earnings_trader.py", "trading/earnings_trader_lambda_handler.py", "trading/logging_utils.py", "trading/retry_utils.py"]
  python_version        = "3.12"
  memory_size           = 256
  timeout               = 900
